...
Route::get('/blog/create', [Controllers\BlogController::class, 'create'])->middleware([Middleware\Authenticate::class])->name('blog.create');
Route::post('/blog/store', [Controllers\BlogController::class, 'store'])->middleware([Middleware\Authenticate::class])->name('blog.store');
Route::get('/blog/{blog}/edit', [Controllers\BlogController::class, 'create'])->middleware([Middleware\Authenticate::class])->name('blog.edit');
...
Route::get('/admin', [Controllers\AdminController::class, 'index'])->middleware([Middleware\Authenticate::class])->name('admin.index');
