<x-layout>
    ...
    <div class="prose md:prose-md lg:prose-lg max-w-none mt-3">
        ...
        <p>
            Sed voluptatem laboriosam At voluptate impedit est eaque minus est galisum quaerat et rerum ducimus et sequi facilis. Nam consequatur nostrum sit tempore quibusdam et nostrum suscipit est rerum voluptatibus. Qui suscipit quidem rem reprehenderit iure est nobis neque et corporis odit cum Quis natus.
        </p>
        <p>
            Id autem atque aut reiciendis galisum sit possimus debitis a tempora ullam. Sed atque voluptatibus eum rerum nihil et cupiditate iure ab internos laborum sit molestiae veritatis!
        </p>
    </div>
</x-layout>
